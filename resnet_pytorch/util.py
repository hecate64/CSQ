...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return Q.Conv2dCSQ(in_planes, out_planes, kernel_size=3, stride=stride,padding=dilation, groups=groups, bias=False, dilation=dilation,  nbits=4)


def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    #return nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)
    return Q.Conv2dCSQ(in_planes, out_planes, kernel_size=1, stride=stride,bias=False, nbits=4)
